		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Resource budget Information",
									"targetURL": "#mygohremployeebudget-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mygohremployeebudget-display": {
								"semanticObject": "mygohremployeebudget",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mygo.hr.employeebudget",
									"url": sap.ui.require.toUrl("mygo/hr/employeebudget")
								}
							}
						}
					}
