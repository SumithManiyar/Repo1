sap.ui.define(
  [
    ...
    "sap/ui/Device",
    "mygo/hr/employeebudget/model/models",
  ],
  function (UIComponent, Device, models) {
    "use strict";

    return UIComponent.extend(
      "mygo.hr.employeebudget.Component",
      {
        metadata: {
          manifest: "json",
        },
        ...
        init: function () {
          ...
          //contains information received from MYINBOX App
          this.setTaskModels();
        ...
        completeTask: function (approvalStatus) {
          this.getModel("context").setProperty("/submit", approvalStatus);
